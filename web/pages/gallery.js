...
const imgAction = (action) => {
  ...
  return (
    ...
    {info.img &&
      ...
      <button onClick={()=> imgAction()} style={{cursor: 'pointer', position: 'absolute', top: '20px', right: '20px', borderRadius: '5px 0px', border: '1px solid #0C0908'}}>X</button>
      <button onClick={()=> imgAction('prev-img')} style={{cursor: 'pointer', position: 'absolute', left: '5%', width: '80px', borderRadius: '5px 0px', border: '1px solid #0C0908'}}><GoArrowLeft size={28}/></button>
      <img src={info.img} style={{width: 'auto', maxWidth: '90%', maxHeight: '90%', borderRadius: '20px 0px', border: '1px solid #0C0908'}}/>
      <button onClick={()=> imgAction('next-img')} style={{cursor: 'pointer',  position: 'absolute', right: '5%', width: '80px', borderRadius: '5px 0px', border: '1px solid #0C0908', }}><GoArrowRight size={28}/></button>
    </div>
    }
            <ResponsiveMasonry
